...
/**
 * Created by mariooliveira on 12/11/2017.
 */
...
class Gauge extends View {
    ...
    public Gauge(Context context, AttributeSet attrs) {
        ...
        // stroke style
        setStrokeWidth(a.getDimension(R.styleable.Gauge_gaugeStrokeWidth, 10));
        setStrokeColor(a.getColor(R.styleable.Gauge_gaugeStrokeColor, ContextCompat.getColor(context, android.R.color.darker_gray)));
        setStrokeCap(a.getString(R.styleable.Gauge_gaugeStrokeCap));

        // angle start and sweep (opposite direction 0, 270, 180, 90)
        setStartAngle(a.getInt(R.styleable.Gauge_gaugeStartAngle, 0));
        setSweepAngle(a.getInt(R.styleable.Gauge_gaugeSweepAngle, 360));

        // scale (from mStartValue to mEndValue)
        setStartValue(a.getInt(R.styleable.Gauge_gaugeStartValue, 0));
        setEndValue(a.getInt(R.styleable.Gauge_gaugeEndValue, 1000));

        // pointer size and color
        setPointSize(a.getInt(R.styleable.Gauge_gaugePointSize, 0));
        setPointStartColor(a.getColor(R.styleable.Gauge_gaugePointStartColor, ContextCompat.getColor(context, android.R.color.white)));
        setPointEndColor(a.getColor(R.styleable.Gauge_gaugePointEndColor, ContextCompat.getColor(context, android.R.color.white)));

        // divider options
        int dividerSize = a.getInt(R.styleable.Gauge_gaugeDividerSize, 0);
        setDividerColor(a.getColor(R.styleable.Gauge_gaugeDividerColor, ContextCompat.getColor(context, android.R.color.white)));
        int dividerStep = a.getInt(R.styleable.Gauge_gaugeDividerStep, 0);
        setDividerDrawFirst(a.getBoolean(R.styleable.Gauge_gaugeDividerDrawFirst, true));
        setDividerDrawLast(a.getBoolean(R.styleable.Gauge_gaugeDividerDrawLast, true));
